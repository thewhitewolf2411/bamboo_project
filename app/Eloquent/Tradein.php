...
class Tradein extends Model
{
     ...
     */
    protected $fillable = [
        'barcode','product_id','network','color','memory','product_state', 'job_state', 'order_price', 'receoved', 'device_missing', 'device_correct', 'device_present_as_described', 'checkmend_passed', 'imei_number', 'change_device',

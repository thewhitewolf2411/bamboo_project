...
class Tradein extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'barcode','barcode_original','product_id','product_state', 'job_state', 'sent_themselves', 'order_price','memory','network', 'receoved', 'device_missing', 'device_correct', 'device_present_as_described', 'checkmend_passed', 'imei_number', 'change_device',

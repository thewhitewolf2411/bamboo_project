...
//payments
Route::get('/portal/payments', 'Portal\PaymentsController@showPaymentPage');
Route::get('/portal/payments/awaiting', 'Portal\PaymentsController@showAwaitingPayments');
Route::get('/portal/payments/submit', 'Portal\PaymentsController@showSubmitPayments');
Route::get('/portal/payments/confirm', 'Portal\PaymentsController@showConfirmPayments');
Route::get('/portal/payments/failed', 'Portal\PaymentsController@showFailedPayments');

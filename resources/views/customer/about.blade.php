    ...
    <div class="about-elements">
        <div class="about-element">
            <div class="about-element-text">
                <p class="left-title-text">About Bamboo</p>
                <p>Hello and welcome to Bamboo Mobile – aka ‘Boo’. In a nutshell, Bamboo Mobile offers a smart way for you to Shop and sell mobile phones and/or devices. With the help of Bamboo Mobile, you can trade in and trade up your mobile, quickly, safely, and simply – not to mention for a great price!
        ...
        <div class="about-element">
            <div class="about-element-text">
                <p class="left-title-text">Sustainability</p>
                <p>ASustainability is at the heart of Bamboo Mobile and everything we do. Like our parent company, Bamboo Distribution, the protection of the environment is central to our ethics and business strategy. 

                ...
                <div class="single-product-container">
                    ...
                    <div class="product-data">
                        ...
                        <div class="product-selected product-memory-container">
                            ...
                            <div class="d-flex">
                            @foreach($productInformation as $info)
                                <input id="info-{{$info->id}}" name="info" value='{ "price1": {{$info->excellent_working}}, "price2": {{$info->good_working}}, "price3": {{$info->poor_working}}}' type="radio" onchange="memoryChanged(this)">
                            @endforeach
                            </div>
                        </div>

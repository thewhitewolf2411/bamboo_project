        ...
        <div class="app">
            <div class="portal-app-container">
                ...
                <div class="portal-search-form-container">
                    ...
                    <form action="/portal/testing/receive/validateserial" method="POST" class="d-flex flex-column">
                        ...
                        <div class="w-100 p-3">
                            <div class="d-flex w-100">
                                ...
                                <div class="d-flex w-50 border p-3"><p>Please enter device serial number</p></div>
                            </div>
                            <div class="d-flex w-100">
                                ...
                                <div class="d-flex w-50 border p-3"><input id="serial_number" type="number" name="serial_number" @if($tradein->serial_number != null) value="{{$tradein->serial_number}}" @endif required title="15 characters required"></div>
                            </div>
                        ...
                        <div class="form-group submit-buttons d-flex justify-content-between w-100 p-3">
                            ...
                            <button id="receive-button" type="submit" class="btn btn-primary btn-blue check-imei">Check Serial</button>
                        </div>

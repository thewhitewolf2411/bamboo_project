...
<head>
    ...
    <title>Bamboo Recycle::Add Tray</title>
</head>
                ...
                <div class="portal-search-form-container">
                    <form action="/portal/trays/createtray" method="POST">
                        <div class="container form-group d-flex flex-column align-items-center justify-content-between">
                            @csrf
                            <input required style="margin: 0; width: 30%; margin-bottom:15px;" class="p-2 form-control" type="text" name="tray_name" id="tray_name" placeholder="Tray name">
